...
export const postCrearComentario = async (req, res, next) => {
    try{
        ...
        const result = await comentariosServices.postCrearComentario(publicacion_id, comentario, usuario_id);
...
export const putActualizarComentario = async (req, res, next) => {
    try{
        ...
        const result = await comentariosServices.putActualizarComentario({ id_comentario, publicacion_id, comentario, usuario_id });
        res.json(result);
    }catch(err){
        return next(err);
    }
...
export const deleteEliminarComentario = async (req, res, next) => {
    try{
        ...
        const result = await comentariosServices.deleteEliminarComentario(id_comentario);
